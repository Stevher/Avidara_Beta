  ...
  "financial-services": [
    {
      ...
      badge: "Standard",
      badgeColor: "var(--indigo)",
      description: "Upload a single client-facing document. Avidara checks it against FAIS General Code and FSCA requirements, with CoFI Bill readiness built in - returning a structured gap report.",
    ...
    },
    {
      ...
      badge: "Deep review",
      badgeColor: "var(--emerald)",
      description: "Upload a document package - Fair Conduct Programme, TMDs, and supporting policies. Avidara reviews the full set against the CoFI Bill's proposed obligations and identifies gaps ahead of enactment.",
...
export default function CTA({ industry }: CTAProps) {
  ...
  return (
    <section id="book" className="scroll-mt-20 px-6 py-20" style={{ backgroundColor: "var(--bg)" }}>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
          {[
            ...
            {
              label: "90-day automatic document deletion",
