...
const findings = [
  {
    ...
    sev: "critical",
    sevLabel: "Critical",
    title: "Incorrect initiation dosing — 5 mg BD vs PI 10 mg BD",
    loc: "Page 2 · Dosing chart · Section 4.2",
  },
  {
    id: "F2",
    sev: "critical",
    sevLabel: "Critical",
    title: 'Product name typo — "Cardivec" not "Cardivex"',
    loc: "Page 2 · Convenience callout",
  },
  {
    id: "F3",
    sev: "major",
    sevLabel: "Major",
    title: "Renal impairment claim inconsistent with approved PI",
    loc: "Page 2 · Renal callout · Section 4.2",
  },
  {
    id: "F4",
    sev: "minor",
    sevLabel: "Minor",
    title: "SI unit — ml/min vs mL/min throughout",
    loc: "Page 2 · Multiple instances",
  },
];
...
const steps = [
  {
    ...
    desc: "Upload your artwork, PI draft, or compliance document alongside the reference PI. Avidara confirms inputs before starting — no partial reviews.",
  },
  {
    n: 2 as Step,
    title: "Avidara runs the review",
    desc: "Every element checked against the encoded regulatory ruleset — claims, dosing, scheduling, mandatory statements, SI units, addresses, dates. Nothing skipped.",
  },
  {
    n: 3 as Step,
    title: "You receive a structured report",
    desc: "A branded PDF finding report with graded findings, exact PI references, locations, and recommendations. Your team reviews, validates, and owns all decisions.",
  },
];
...
export default function HowItWorksDemo() {
  ...
  return (
    <section id="how-it-works" className="px-6 py-32" style={{ backgroundColor: "var(--bg)" }}>
                  ...
                  >
                    <div
                      className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-sm font-bold transition-colors ${
                        active
                          ...
                          : "border border-[var(--b2)] text-[var(--t3)]"
                      }`}
                    ...
                    <div>
                      <h4
                        ...
                        style={{ color: active ? "var(--t)" : "var(--t2)" }}
                      >
                        {s.title}
                      </h4>
            ...
            <div className="rounded-2xl border border-[var(--b)] overflow-hidden" style={{ boxShadow: "var(--shadow-lg)", backgroundColor: "var(--surf2)" }}>
              ...
              {step === 1 && (
                <div className="p-6">
                  ...
                  >
                    ...
                    <p className="mb-1 font-semibold" style={{ color: "var(--t)" }}>Drop your artwork file here</p>
                    <p className="mb-4 text-sm" style={{ color: "var(--t3)" }}>PDF, AI, INDD — max 50 MB</p>
                    <button
                      className="rounded-lg border px-4 py-2 text-sm font-medium transition-colors hover:border-[var(--indigo)] hover:text-[var(--indigo)]"
                  ...
                  <div
                    ...
                    style={{ borderColor: "var(--emerald)", backgroundColor: "rgba(16,185,129,.06)" }}
                  >
                    ...
                    <div>
                      <p className="text-sm font-medium" style={{ color: "var(--t)" }}>Cardivex_HCP_LeaveBehind_A5_v2.pdf</p>
                      <p className="text-xs" style={{ color: "var(--t3)" }}>2.8 MB · Reference PI: EVD-NX-001/SA · Ready</p>
                    </div>
                  </div>
                ...
                <div className="p-6">
                  <div className="mb-6 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs" style={{ color: "var(--t3)" }}>Cardivex HCP Leave-Behind · 2 pages</p>
                    </div>
                  </div>
                    ...
                    {checks.map((item, i) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            color: done ? "var(--emerald)" : curr ? "var(--t)" : "var(--t3)",
                            opacity: i > checked.length + 1 ? 0.4 : 1,
                          }}
                        >
                          {done ? (
                  ...
                  <div className="mb-5 h-1.5 overflow-hidden rounded-full" style={{ backgroundColor: "var(--b2)" }}>
                    <div
                      className="h-full rounded-full bg-[var(--indigo)] transition-all duration-500 ease-out"
              ...
              {step === 3 && (
                <div className="p-6">
                  {/* Outcome banner */}
                  <div
                    className="mb-5 flex flex-col items-center rounded-xl border py-5 text-center"
                    style={{ borderColor: "rgba(239,68,68,.25)", backgroundColor: "rgba(239,68,68,.05)" }}
                  >
                    <div className="mb-1 flex items-center gap-2">
                      <span className="h-2 w-2 rounded-full bg-red-400" />
                      <span className="text-sm font-bold" style={{ color: "var(--t)" }}>Not Approved for Release</span>
                    </div>
                    <p className="text-xs" style={{ color: "var(--t3)" }}>2 Critical · 4 Major · 2 Minor</p>
                  </div>
