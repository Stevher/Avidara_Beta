...
- **Device description and specifications**, including intended purpose, indications for use, and any contraindications
- **Essential Principles of Safety and Performance** checklist, with references to standards and test reports that demonstrate conformity
- **Risk management documentation** per ISO 14971, including the risk management plan, hazard analysis, and residual risk evaluation
- **Clinical evidence**, which may range from a clinical evaluation report based on literature to full clinical investigation data, depending on device class and novelty
- **Labelling and instructions for use**, compliant with South African requirements including language provisions
- **Post-market surveillance plan**, detailing how the manufacturer intends to monitor device performance once on the market

For IVDs, additional requirements around analytical and clinical performance evaluation apply, broadly mirroring the structure seen under the EU IVDR.
...
The message is straightforward: SAHPRA's device registration system is maturing, and the tolerance for incomplete or poorly structured submissions is narrowing. Manufacturers who invest in dossier quality before submission will see faster approvals and fewer cycles of deficiency responses. Those who do not will find themselves in a growing backlog.

Avidara's Dossier Review service is designed to catch the gaps that delay medical device registrations before they reach SAHPRA's desk. Our regulatory specialists assess technical files against current SAHPRA requirements, flag deficiencies, and provide actionable recommendations to strengthen your submission. If your next device dossier needs a critical eye, [book a review](/#book).
